...
private Button nexbut; //保存图片ID的数组 
int[] imageId = new int[]{R.mipmap.lion, R.mipmap.tiger, R.mipmap.monkey, R.mipmap.dog, R.mipmap.cat, R.mipmap.elephant}; //定义并初始化保存列表项文字的数 
...
{ private ListView listview; 
SimpleAdapter adapter; //定义并初始化保存图片ID的数组
int[] imageId = new int[]{R.mipmap.timg, R.mipmap.timg, R.mipmap.timg, R.mipmap.timg, R.mipmap.timg, R.mipmap.timg}; //定义并初始化保存列表项文字的数 
